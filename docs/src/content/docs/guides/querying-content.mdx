...
| `--emdash-inline-code-border` | Code-block and control borders |
...
:root {
  --emdash-inline-code-background: #f6f8fa;
...
:root.dark {
  --emdash-inline-code-background: #0d1117;
  --emdash-inline-code-foreground: #f0f3f6;
  --emdash-inline-code-muted: #c9d1d9;
  --emdash-inline-code-keyword: #ffbcb5;
